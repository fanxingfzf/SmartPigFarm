...
public class FiveChessView extends View implements View.OnTouchListener {
    ...
    public FiveChessView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //初始化棋子图片bitmap
        whiteChess = BitmapFactory.decodeResource(context.getResources(), R.drawable.jm3);
        blackChess = BitmapFactory.decodeResource(context.getResources(), R.drawable.jm4);
        //初始化胜利局数
        whiteChessCount = 0;
        blackChessCount = 0;
        //初始化Rect
